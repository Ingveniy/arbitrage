...
// TODO: Установить библиотеку для отрисовки графиков
// TODO: Вывести данные на график
// TODO: Сделать определение самой волотильной пары для выбранных бирж
...
/* STAGE 1
1. Запрашиваем список бирж
2. Выбираем биржу 1
3. Выбираем биржу 2
4. Запрашиваем общие доступные пары для бирж
5. Выбираем пару валют
6. Начинаем трекать статистику с бирж
7. Рисуем график
*/
